      ...
      >
        {status === 'loading' && (
          <>
            ...
            <h1 className="text-2xl font-bold mb-2 lowercase">confirming your email...</h1>
        ...
        {status === 'success' && (
          <>
            ...
            <h1 className="text-2xl font-bold mb-2 lowercase">email confirmed! 🎉</h1>
            ...
            <p className="text-sm text-gray-500 lowercase">redirecting you to the waitlist...</p>
          </>
        )}
        ...
        {status === 'error' && (
          <>
            ...
            <h1 className="text-2xl font-bold mb-2 lowercase">confirmation failed</h1>
