...
// Google reCAPTCHA v2 site key (test key - replace with your own)
...
export default function PlugWaitlist() {
  ...
  // ALL 33 LAGOS LOCATIONS (20 LGAs + 13 Popular Areas) - Alphabetically Sorted
  const locations = [
    // 20 Lagos LGAs
    'Agege',
    'Ajeromi-Ifelodun',
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store additional data in analytics_events (no PII)
      await supabase
      ...
      // Update referrer's count using RPC
      if (referredBy) {
      ...
      <section className="min-h-screen py-12 px-4 md:px-8 bg-slate-50 font-system">
        ...
        <div className="max-w-6xl w-full mx-auto">
          ...
          >
            ...
            >
              <div className="flex items-center justify-between">
                <span className="text-xs text-gray-500 lowercase">launching march 2026</span>
              ...
              <form onSubmit={submit} className="mt-5 space-y-3">
                ...
                {/* Location - ALL 33 LAGOS LOCATIONS */}
                <motion.div
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
